...
int main(int argc, char const *argv[])
{
    ...
    // writing to server with CML string (that was created from CML args by user interaction)
    write(sockfd, info_str.c_str(), info_str.length());

    // reads what was sent from server...
    ...
    // to be separated by a space (from our tcp server code)... hence, we scan it like that
